                    ...
                    <div class="row">
                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="websiteId" class="col-xs-12 select2-ui">
                                                <option <#if !(customer.websiteId)??>selected=""</#if> value="">选择网站群组
                                                </option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" title="是否报备">报备</label>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" title="住院情况">是否住院</label>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" title="患者意向">意向</label>
