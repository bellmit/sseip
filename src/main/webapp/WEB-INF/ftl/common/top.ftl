            ...
            <ul class="nav ace-nav">
                            ...
                            <ul class="dropdown-menu dropdown-navbar">
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="${context.contextPath}/resources/ace/assets/avatars/avatar.png"
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="${context.contextPath}/resources/ace/assets/avatars/avatar3.png"
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="${context.contextPath}/resources/ace/assets/avatars/avatar4.png"
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="${context.contextPath}/resources/ace/assets/avatars/avatar2.png"
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="${context.contextPath}/resources/ace/assets/avatars/avatar5.png"
                ...
                <li class="light-blue">
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        <li>
                            <a href="${context.contextPath}/admin/system/baseinfo" target="mainFrame">
                        ...
                        <li>
                            <a href="${context.contextPath}/admin/user/showSelf" target="mainFrame">
