...
<script src="${context.contextPath}/resources/ace/assets/js/jquery.js"></script>
...
<script src="${context.contextPath}/resources/ace/assets/js/ace/ace.widget-box.js"></script>
<script src="${context.contextPath}/resources/ace/assets/js/ace/ace.settings.js"></script>
...
<script src="${context.contextPath}/resources/ace/docs/assets/js/language/generic.js"></script>
