...
<div class="main-content-inner">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="${context.contextPath}/country/list/1">贸易国家一览</a></li>
            <li class="active">更新贸易国家条目</li>
        </ul>
        <!-- /.breadcrumb -->
    </div>
                ...
                <#if errors??>
                    ...
                    <div class="clearfix form-actions">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <button class="btn" type="reset"><span class="ace-icon fa fa-undo bigger-110"></span>重置表单
                            </button>
                        </div>
                    </div>
                </form>
