                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="name" type="text" size="30" class="col-xs-10 col-sm-5"
                                   placeholder="姓名" value="${(form.name)!''}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="address" type="text" size="30" class="col-xs-10 col-sm-5"
                                   placeholder="地址" value="${(form.address)!''}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <#list websites as website>
                                <option <#if (form.website.code)?? && form.website.code=website.code>selected=""</#if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <#list diseaseTypes as diseaseType>
                                <option <#if ((form.diseaseType.code)!-1)=diseaseType.code>selected=""</#if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <#list accessPointTypes as accessPointType>
                                <option
                                    <#if (form.accessPointType.code)?? && form.accessPointType.code=accessPointType.code>selected=""</#if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="faraway" class="col-xs-10 col-sm-5">
                                <option <#if (form.faraway)?? && form.faraway>selected=""</#if> value="1">遥远</option>
                                <option <#if !(form.faraway)?? || !(form.faraway)>selected=""</#if> value="0">不远
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="emergency" class="col-xs-10 col-sm-5">
                                <option <#if (form.emergency)?? && form.emergency>selected=""</#if> value="1">急救
                                </option>
                                <option <#if !((form.emergency)??) || !(form.emergency)>selected=""</#if> value="0">不急救
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="clearfix form-actions">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="btn btn-info" type="submit">
                                <span class="ace-icon fa fa-plus bigger-110"></span>提交资料
                            </button>
